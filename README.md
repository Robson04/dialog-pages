...
[![sampctl](https://img.shields.io/badge/sampctl-dialog_pages-2f2f2f.svg?style=for-the-badge)](https://github.com/DignitySAMP/dialog_pages)
...
```bash
sampctl package install DignitySAMP/dialog_pages
```

Include in your code and begin using the library:

```pawn
#include <dialog_pages>
```
...
<img src="https://i.imgur.com/Debag70.gif" />
...
```
  ...
  - **inputtext[]** - return a content of clicked listitem.
...
- [Original Repository](https://github.com/Robson04/dialog-pages)